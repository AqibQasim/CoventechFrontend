...
<h2 className="text-xl font-bold">Understanding the Role of a QA Software Engineer</h2>
...
<img src="role_image.jpg" alt="Role of a QA Software Engineer" className="mx-auto my-4" />

<h2 className="text-xl font-bold">The Evolution of Software Testing and Automation</h2>
...
<img src="timeline_image.jpg" alt="Timeline of Software Testing and Automation" className="mx-auto my-4" />
