  ...
  <div className="relative z-10 w-1/2 text-black hidden md:block">
    ...
    <div className="relative z-20 flex flex-col items-start">
      ...
      <div className="relative z-10 w-full md:w-1/2 text-black sm:w-[1/1] text-center md:text-left">
        ...
        <p className={`mb-8 md:w-4/5 text-lg font-normal leading-7 xsm:text-center md:text-left ${styles.para}`}>
          We are Focused on crafting the future of technology with today's innovative solutions. Our software development experts and QA automation engineers are seamlessly committed to transforming your business's with the latest tech solutions.
        </p>
