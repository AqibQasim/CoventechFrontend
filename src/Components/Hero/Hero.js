  ...
  <div className="relative z-10 w-1/2 text-black hidden md:block">
    ...
    <div className="relative z-20 flex flex-col items-start">
      ...
      <div className="relative z-10 w-full md:w-1/2 text-black sm:w-[1/1] text-center md:text-left">
        ...
        <p className={`mb-8 md:w-4/5 text-lg font-normal leading-7 ${styles.para}`}>
        ...
        <Link smooth={true} duration={800} onClick={() => scrollToSection("Contact")}><button type="button" className="text-white bg-secondary hover:bg-secondary-800 focus:ring-4 focus:outline-none focus:ring-secondary-300 font-medium rounded-lg text-lg px-8 py-2 text-center dark:bg-secondary-600 dark:hover:bg-secondary-700 dark:focus:ring-secondary-800 hover:bg-primary hover:text-secondary transition-all duration-500">Get In Touch</button></Link>
      </div>
    </div>
    );    
}
